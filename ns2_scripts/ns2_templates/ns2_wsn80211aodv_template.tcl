...
set val(nn)             51
set val(tr)     output80211_xx.tr;# trace file
set val(nam)    output8211_xx.nam;# nam trace file
set val(move)  [file name]   ;# movement scenario
set val(cp)     [file name];# connection traffic
set val(starttime) 5;
