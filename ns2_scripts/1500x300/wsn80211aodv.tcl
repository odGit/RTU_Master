...
set val(nn)             51
set val(tr)     output80211_max0_p10.tr;# trace file
set val(nam)    output80211_max0_p10.nam;# nam trace file
set val(move)   trafCBR_rate4.traff   ;# movement scenario
set val(cp)     scen_max0_p0.scen;# connection traffic
set val(starttime) 5;
